...
BOOST_CLASS_EXPORT_GUID(spine::common::UpdatePlayTimeMessage, "10")
BOOST_CLASS_IMPLEMENTATION(spine::common::UpdatePlayTimeMessage, boost::serialization::object_serializable)
...
BOOST_CLASS_EXPORT_GUID(spine::common::RequestSingleModStatMessage, "36")
BOOST_CLASS_IMPLEMENTATION(spine::common::RequestSingleModStatMessage, boost::serialization::object_serializable)
BOOST_CLASS_EXPORT_GUID(spine::common::SendSingleModStatMessage, "37")
BOOST_CLASS_IMPLEMENTATION(spine::common::SendSingleModStatMessage, boost::serialization::object_serializable)
...
BOOST_CLASS_EXPORT_GUID(spine::common::SendUserInfosMessage, "53")
BOOST_CLASS_IMPLEMENTATION(spine::common::SendUserInfosMessage, boost::serialization::object_serializable)
...
BOOST_CLASS_EXPORT_GUID(spine::common::RequestCompatibilityListMessage, "60")
BOOST_CLASS_IMPLEMENTATION(spine::common::RequestCompatibilityListMessage, boost::serialization::object_serializable)
BOOST_CLASS_EXPORT_GUID(spine::common::SendCompatibilityListMessage, "61")
BOOST_CLASS_IMPLEMENTATION(spine::common::SendCompatibilityListMessage, boost::serialization::object_serializable)
BOOST_CLASS_EXPORT_GUID(spine::common::RequestRatingMessage, "62")
BOOST_CLASS_IMPLEMENTATION(spine::common::RequestRatingMessage, boost::serialization::object_serializable)
BOOST_CLASS_EXPORT_GUID(spine::common::SendRatingMessage, "63")
BOOST_CLASS_IMPLEMENTATION(spine::common::SendRatingMessage, boost::serialization::object_serializable)
...
BOOST_CLASS_EXPORT_GUID(spine::common::UpdateRequestEncryptedMessage, "65")
BOOST_CLASS_IMPLEMENTATION(spine::common::UpdateRequestEncryptedMessage, boost::serialization::object_serializable)
...
BOOST_CLASS_EXPORT_GUID(spine::common::RequestModManagementMessage, "76")
BOOST_CLASS_IMPLEMENTATION(spine::common::RequestModManagementMessage, boost::serialization::object_serializable)
BOOST_CLASS_EXPORT_GUID(spine::common::SendModManagementMessage, "77")
BOOST_CLASS_IMPLEMENTATION(spine::common::SendModManagementMessage, boost::serialization::object_serializable)
...
BOOST_CLASS_EXPORT_GUID(spine::common::UpdateModVersionMessage, "79")
BOOST_CLASS_IMPLEMENTATION(spine::common::UpdateModVersionMessage, boost::serialization::object_serializable)
BOOST_CLASS_EXPORT_GUID(spine::common::UpdateEarlyAccessStateMessage, "80")
BOOST_CLASS_IMPLEMENTATION(spine::common::UpdateEarlyAccessStateMessage, boost::serialization::object_serializable)
...
BOOST_CLASS_EXPORT_GUID(spine::common::UpdateOfflineDataMessage, "83")
BOOST_CLASS_IMPLEMENTATION(spine::common::UpdateOfflineDataMessage, boost::serialization::object_serializable)
BOOST_CLASS_EXPORT_GUID(spine::common::RequestOfflineDataMessage, "84")
BOOST_CLASS_IMPLEMENTATION(spine::common::RequestOfflineDataMessage, boost::serialization::object_serializable)
BOOST_CLASS_EXPORT_GUID(spine::common::SendOfflineDataMessage, "85")
BOOST_CLASS_IMPLEMENTATION(spine::common::SendOfflineDataMessage, boost::serialization::object_serializable)
BOOST_CLASS_EXPORT_GUID(spine::common::UpdateStartTimeMessage, "86")
BOOST_CLASS_IMPLEMENTATION(spine::common::UpdateStartTimeMessage, boost::serialization::object_serializable)
BOOST_CLASS_EXPORT_GUID(spine::common::UpdatePlayingTimeMessage, "87")
BOOST_CLASS_IMPLEMENTATION(spine::common::UpdatePlayingTimeMessage, boost::serialization::object_serializable)
...
BOOST_CLASS_EXPORT_GUID(spine::common::UpdateGeneralModConfigurationMessage, "95")
BOOST_CLASS_IMPLEMENTATION(spine::common::UpdateGeneralModConfigurationMessage, boost::serialization::object_serializable)
BOOST_CLASS_EXPORT_GUID(spine::common::UpdateScoresMessage, "96")
BOOST_CLASS_IMPLEMENTATION(spine::common::UpdateScoresMessage, boost::serialization::object_serializable)
BOOST_CLASS_EXPORT_GUID(spine::common::UpdateAchievementsMessage, "97")
BOOST_CLASS_IMPLEMENTATION(spine::common::UpdateAchievementsMessage, boost::serialization::object_serializable)
...
BOOST_CLASS_EXPORT_GUID(spine::common::UpdateImpressionMessage, "100")
BOOST_CLASS_IMPLEMENTATION(spine::common::UpdateImpressionMessage, boost::serialization::object_serializable)
