...
void ILauncher::removeScore(int32_t projectID, int32_t identifier) {
	Database::DBError err;
...
void ILauncher::removeAchievement(int32_t projectID, int32_t identifier) {
	Database::DBError err;
...
void ILauncher::removeAchievementProgress(int32_t projectID, int32_t identifier) {
	Database::DBError err;
...
void ILauncher::removeOverallSaveData(int32_t projectID, const std::string & key) {
	Database::DBError err;
