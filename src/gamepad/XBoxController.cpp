...
void GamePadXbox::update() {
	...
	const float leftThumbY = _controllerState.Gamepad.sThumbLY;
	if (leftThumbY) {
		State._left_thumbstick.Y = leftThumbY;
	}
	const float leftThumbX = _controllerState.Gamepad.sThumbLX;
	if (leftThumbX) {
	...
	const float rightThumbY = _controllerState.Gamepad.sThumbRY;
	if (rightThumbY) {
		State._right_thumbstick.Y = rightThumbY;
	}
	const float rightThumbX = _controllerState.Gamepad.sThumbRX;
	if (rightThumbX) {
