...
IF(UNIX)
	...
	SET(CLOCKUTILS_DEBUG_LIBRARIES ${CLOCKUTILS_LIBRARIES})
	SET(CLOCKUTILS_RELEASE_LIBRARIES ${CLOCKUTILS_LIBRARIES})
ELSEIF(WIN32)
	SET(LIBNAME "CLOCKUTILS_DEBUG")
	SET(LIBHEADER "clockUtils/errors.h")
	SET(CLOCKUTILS_DEBUG_ROOT ${SPINE_DEP_DIR}/clockUtils/Debug)
	SET(CLOCKUTILS_DEBUG_COMPONENT ${CLOCKUTILS_DEBUG_COMPONENT} ${CLOCKUTILS_COMPONENT})

	find_package(EasyFind REQUIRED COMPONENTS ${CLOCKUTILS_DEBUG_COMPONENT})
	include_directories(SYSTEM ${CLOCKUTILS_DEBUG_INCLUDE_DIR})

	SET(LIBNAME "CLOCKUTILS_RELEASE")
	SET(CLOCKUTILS_RELEASE_ROOT ${SPINE_DEP_DIR}/clockUtils/Release)
	SET(CLOCKUTILS_RELEASE_COMPONENT ${CLOCKUTILS_RELEASE_COMPONENT} ${CLOCKUTILS_COMPONENT})

	find_package(EasyFind REQUIRED COMPONENTS ${CLOCKUTILS_RELEASE_COMPONENT})
ENDIF(UNIX)
...
IF(WITH_SERVER)
	...
	SET(LIBNAME "MARIADB")
	SET(LIBHEADER "mariadb/ma_common.h")
...
IF(WITH_CLIENT OR WITH_G2OCHECKER)
	...
	IF(SUPPORTSWEBENGINE)
		SET(QT_SEARCH_MODULES ${QT_SEARCH_MODULES} WebEngine)
		SET(QT_SEARCH_MODULES ${QT_SEARCH_MODULES} WebEngineWidgets)
	ENDIF()
	...
	IF(SUPPORTSWEBENGINE)
		...
		SET(QT_LIBRARIES ${QT_LIBRARIES} ${Qt5WebEngine_LIBRARIES})
		INCLUDE_DIRECTORIES(${Qt5WebEngineWidgets_INCLUDE_DIRS})
		SET(QT_LIBRARIES ${QT_LIBRARIES} ${Qt5WebEngineWidgets_LIBRARIES})
...
IF(UNIX)
	...
	SET(BOOST_DEBUG_LIBRARIES ${BOOST_LIBRARIES})
	SET(BOOST_RELEASE_LIBRARIES ${BOOST_LIBRARIES})
ELSEIF(WIN32)
	SET(LIBNAME "BOOST_DEBUG")
	SET(LIBHEADER "boost/thread.hpp")
	SET(BOOST_DEBUG_ROOT ${SPINE_DEP_DIR}/boost/Debug)
	SET(BOOST_DEBUG_COMPONENT ${BOOST_COMPONENT})

	find_package(EasyFind REQUIRED COMPONENTS ${BOOST_DEBUG_COMPONENT})
	include_directories(SYSTEM ${BOOST_DEBUG_INCLUDE_DIR})

	SET(LIBNAME "BOOST_RELEASE")
	SET(BOOST_RELEASE_ROOT ${SPINE_DEP_DIR}/boost/Release)
	SET(BOOST_RELEASE_COMPONENT ${BOOST_COMPONENT})

	find_package(EasyFind REQUIRED COMPONENTS ${BOOST_RELEASE_COMPONENT})
ENDIF(UNIX)
